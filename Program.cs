        ...
        static void Main(string[] args)
        {
            ...
            switch (input)
            {
                ...
                case "3":
                    ...
                    if (int.TryParse(multiplyNumber1, out int multiplicationNumOne) && int.TryParse(multiplyNumber2, out int multiplicationNumTwo))
                    {
                        Console.Write($"{multiplyNumber1} * {multiplyNumber2} = ");
                        Console.Write(calculator.Multiply(multiplicationNumOne, multiplicationNumTwo));
                    }
                    else
                    {
                        Console.WriteLine("One or more of the numbers is not an int");
